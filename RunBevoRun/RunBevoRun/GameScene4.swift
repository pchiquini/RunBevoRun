...
class GameScene4: SKScene, SKPhysicsContactDelegate {
    ...
    let backgroundMusic: SKAudioNode = SKAudioNode(fileNamed: "DeepInTheHeartOfTexas.mp3")
    ...
    private var itemController = Item4Class()
    private var platformController = Platform4Class()
    ...
    func createScene(){
        ...
        /** Initializing Timer **/
        Timer.scheduledTimer(timeInterval: 20.0, target: self, selector: #selector(GameScene4.timeIsOut), userInfo: true, repeats: false)
        ...
        Timer.scheduledTimer(timeInterval: TimeInterval(itemController.randomNumber(firstNum: 1, secondNum: 3)), target: self, selector: #selector(GameScene4.addItems), userInfo: nil, repeats: true)
        
        Timer.scheduledTimer(timeInterval: TimeInterval(platformController.randomNumber(firstNum: 1, secondNum: 2)), target: self, selector: #selector(GameScene4.addPlatforms), userInfo: nil, repeats: true)
