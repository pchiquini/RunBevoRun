...
class GameScene3: SKScene, SKPhysicsContactDelegate {
    ...
    let backgroundMusic: SKAudioNode = SKAudioNode(fileNamed: "Downtown.mp3")
    ...
    private var itemController = Item3Class()
    private var platformController = Platform3Class()
    ...
    func createScene(){
        ...
        /** Initializing Timer **/
        Timer.scheduledTimer(timeInterval: 28.0, target: self, selector: #selector(GameScene3.timeIsOut), userInfo: true, repeats: false)
        ...
        Timer.scheduledTimer(timeInterval: TimeInterval(itemController.randomNumber(firstNum: 1, secondNum: 2)), target: self, selector: #selector(GameScene3.addItems), userInfo: nil, repeats: true)
        
        Timer.scheduledTimer(timeInterval: TimeInterval(platformController.randomNumber(firstNum: 1, secondNum: 5)), target: self, selector: #selector(GameScene3.addPlatforms), userInfo: nil, repeats: true)
